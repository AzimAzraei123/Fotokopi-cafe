    ...
    <div class="outerbox">
        <div class="container-fluid light-container">
            <form action="" method="post">
                <fieldset>
                    <legend>
                        <center>Customer Login Page</center>
                    </legend>
                    <?php
                ...
                <center><button type="button" class="btn btn-custom" onclick="window.location.href='register.php'">Sign Up</button></center>
            </form>
        </div>
    </div>
    ...
    if (isset($_POST['loginBtn'])) {
        ...
        if ($res) {
            ...
            if ($count == 1) {
                ...
                header('Location:' . SITEURL . 'Cust_Page/custMain.php?id=' . $custID);
                exit();
            } else {
